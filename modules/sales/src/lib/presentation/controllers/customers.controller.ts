...
export class CustomersController {
  ...
  findAll() { return this.customerRepository.findAll(); }

  @Get(':id')
  @RequirePermission('sales.customers.view')
  findOne(@Param('id') id: string) { return this.customerRepository.findById(id); }

  @Post()
  @RequirePermission('sales.customers.create')
  create(@Body() dto: CreateCustomerDto) { return this.createCustomerUseCase.execute(dto); }
  ...
  remove(@Param('id') id: string) { return this.customerRepository.delete(id); }
}