...
import { Form, Input, Select, Switch, Button, ConfigProvider } from 'antd';
...
export default function CreateWarehousePage() {
  ...
  // Watch the isActive value to dynamically style the label or switch if needed
    ...
    <ConfigProvider
      theme={{
        token: {
          ...
          colorPrimary: '#0f172a', // Dark blue/black for main actions
          colorBorder: '#e2e8f0',
          borderRadius: 8,
          controlHeight: 44, // Large inputs
          controlHeightLG: 44,
        },
        components: {
          Switch: {
            colorPrimary: '#3b82f6', // Bright blue for the switch as requested
